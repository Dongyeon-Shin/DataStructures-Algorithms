namespace Iterator
{
    ...
    {
	    // 반복자는 대부분의 자료구조가 사용하는 자료구조가 보관중인 모든 데이터를 하나씩 접근할 수 있게하는 기능이다.
        // 특히 c++에선 굉장히 중요한데 대부분의 알고리즘이 반복자를 이용해서 구현되어 있다.
        // c#에선 그정도는 아니지만 인터페이스로 구현되어 있어 자료구조를 반복시킬때 사용하거나 직접 자료구조를 만들었을때
        // 세부 기능을 일일히 다 만들 필요가 없도록 사용할 수 있다.
